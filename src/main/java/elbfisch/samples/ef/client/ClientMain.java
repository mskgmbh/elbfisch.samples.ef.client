...
package elbfisch.samples.ef.client;
...
public class ClientMain extends Module{
    ...
    public ClientMain(){
        super(null, "Main");
        try{
            toggle      = new IoLogical(this, "toggle", new URI("ef://localhost:13685/Main.toggle"), IoDirection.INPUT);
            lastCommand = new IoSignedInteger(this, "lastCommand", new URI("ef://localhost:13685/Main.lastCommand"), IoDirection.INPUT);
            handshake   = new Handshake(this, "handshake", new URI("ef://localhost:13685/Main.handshake"));
            comment     = new IoCharString(this, "comment", new URI("ef://localhost:13685/Main.comment"), IoDirection.INPUT);
            analogValue = new IoDecimal(this, "analogValue", new URI("ef://localhost:13685/Main.analogValue"), IoDirection.INPUT);
        }
        catch(Exception exc){
            Log.error("Error:", exc);
        };
